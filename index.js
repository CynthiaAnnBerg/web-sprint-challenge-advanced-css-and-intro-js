...
artists.splice(9,1,'Vincent Von Gough');
console.log(artists);
...
console.log(removeArtist(artists, 'Amedeo Modigliani'));
...
console.log(addArtist(19,'Cynthia Berg', '1994-2021','Web Design','American','Cynthia was born in CO, and is currently a full time artist learning Javascript'));
